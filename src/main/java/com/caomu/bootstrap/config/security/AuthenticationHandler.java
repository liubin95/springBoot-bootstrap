...
public class AuthenticationHandler implements AuthenticationFailureHandler, AuthenticationSuccessHandler, AuthenticationEntryPoint, LogoutSuccessHandler, AccessDeniedHandler {
    ...
    @Autowired
    public AuthenticationHandler(ObjectMapper objectMapper, RMapCache<Long, BaseUserDetail> authIdUserMap,
                                 TokenUtil<BaseEntity> baseEntityTokenUtil, CaoMuProperties caoMuProperties) {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        if (authIdUserMap.containsKey(baseUserDetail.getId())) {
            LOGGER.info("重复登录,用户id：{}", baseUserDetail.getId());
            // 顶号
            baseUserDetail = authIdUserMap.get(baseUserDetail.getId());
